...
* Netavark will now detect and error out when the aardvark-dns configuration would have its own listening ip set as upstream server to avoid a dns loop. ([containers/aardvark-dns#415](https://github.com/containers/aardvark-dns/issues/415))
* Dependency updates.
